  ...
  describe('methods', () => {
    ...
    describe('simple', () => {
      describe('schedule', () => {
        ...
        const genOperationFixture = async () => {
        ...
        it('proposer can schedule', async () => {
          ...
          const {id, target, value, data, predecessor, salt} = await loadFixture(genOperationFixture);
        ...
        it('prevent overwriting active operation', async () => {
          const { timelock,proposer } = await loadFixture(deployTimelockFixture);
          const {target, value, data, predecessor, salt} = await loadFixture(genOperationFixture);
        ...
        it('enforce minimum delay', async () => {
          const { timelock,proposer } = await loadFixture(deployTimelockFixture);
          const {target, value, data, predecessor} = await loadFixture(genOperationFixture);
      ...
      describe('execute', () => {
        ...
        describe('with scheduled operation', () => {
          ...
          describe('on time', () => {
            ...
            beforeEach (async () => {
              const { timelock } = await loadFixture(deployTimelockFixture);
              const {id} = await loadFixture(genOperationFixture);
      ...
      describe('execute', () => {
        ...
        describe('with scheduled operation', () => {
          ...
          describe('on time', () => {
            ...
            const inscreaseTimeFixture = async () => {
              const { timelock } = await loadFixture(deployTimelockFixture);
              const {id} = await loadFixture(genOperationBatchFixture);
              const timestamp = await timelock.getTimestamp(id);
              await time.increaseTo(timestamp)
            };
            ...
            it('executor can reveal', async () => {
              ...
              const { id, targets, values, payloads, predecessor, salt} = await loadFixture(genOperationBatchFixture);
              await loadFixture(scheduleBatchFixture);
              await loadFixture(inscreaseTimeFixture);
            ...
            it('length mismatch #1', async () => {
              const { timelock, executor } = await loadFixture(deployTimelockFixture);
              const { values, payloads, predecessor, salt} = await loadFixture(genOperationBatchFixture);
              await loadFixture(scheduleBatchFixture);
              await loadFixture(inscreaseTimeFixture);
              await expectRevert(
                timelock.connect(executor).executeBatch(
        ...
        it('partial execution', async () => {
          ...
          (operation = {  targets, values, payloads, predecessor, salt } = genOperationBatch(
