...
export interface Ink_Timelock_GovernorInterface extends utils.Interface {
  functions: {
    ...
    "cancel_(address[],uint256[],bytes[],bytes32)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "cancel_", data: BytesLike): Result;
...
export interface Ink_Timelock_Governor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Ink_Timelock_GovernorInterface;
