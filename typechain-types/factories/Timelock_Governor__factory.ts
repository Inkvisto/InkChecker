...
import type {
  Timelock_Governor,
  Timelock_GovernorInterface,
} from "../Timelock_Governor";
...
type Timelock_GovernorConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: Timelock_GovernorConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class Timelock_Governor__factory extends ContractFactory {
  constructor(...args: Timelock_GovernorConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<Timelock_Governor> {
    return super.deploy(
      _token,
      _timelock,
      overrides || {}
    ) as Promise<Timelock_Governor>;
  }
  ...
  override attach(address: string): Timelock_Governor {
    return super.attach(address) as Timelock_Governor;
  }
  override connect(signer: Signer): Timelock_Governor__factory {
    return super.connect(signer) as Timelock_Governor__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): Timelock_GovernorInterface {
    return new utils.Interface(_abi) as Timelock_GovernorInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Timelock_Governor {
    return new Contract(address, _abi, signerOrProvider) as Timelock_Governor;
  }
}
