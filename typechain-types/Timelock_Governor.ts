...
export interface Timelock_GovernorInterface extends utils.Interface {
  functions: {
...
export interface Timelock_Governor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Timelock_GovernorInterface;
