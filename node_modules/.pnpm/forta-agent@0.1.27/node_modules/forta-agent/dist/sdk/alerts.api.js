...
var getAlerts = function (query) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4, axios_1.default.post(getAlertsApiURL(), getQueryFromAlertOptions(query), getAlertsApiHeaders())];
            case 1:
                response = _b.sent();
...
var getAlertsApiURL = function () {
    ...
    var alertsApiUrl = (0, utils_1.getFortaConfig)().alertsApiUrl;
    if (!alertsApiUrl)
        return "https://api.forta.network/graphql";
    return alertsApiUrl;
};
var getAlertsApiHeaders = function () {
    var headers = { "content-type": "application/json" };
    var fortaApiKey = (0, utils_1.getFortaConfig)().fortaApiKey;
    if (fortaApiKey) {
